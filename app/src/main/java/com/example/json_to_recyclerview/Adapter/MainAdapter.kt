...
class MainAdapter(val context: Context, val employeesList: OfficeResponse) : RecyclerView.Adapter<ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val employeeData = employeesList.data[position]
...
//        Picasso.get().load(employeeData.profileImage).into(holder.imageView)
    ...
    override fun getItemCount(): Int {
        return employeesList.data.size
    }
}
